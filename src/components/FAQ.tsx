    ...
    <Section containerClassName="max-w-6xl">
        ...
        <div className="space-y-4 text-center mx-auto max-w-3xl">
          ...
          <h2 className="text-5xl md:text-6xl font-black tracking-tighter text-foreground leading-[0.9]">
            {t("faq.title_start")} <span className="text-primary italic font-serif">{t("faq.title_end")}</span>
          </h2>
          ...
          {faqs.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <div className={`w-10 h-10 shrink-0 rounded-2xl flex items-center justify-center border transition-all duration-500 ${openIndex === idx
