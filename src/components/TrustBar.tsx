  ...
  return (
    <section className="py-12 bg-background border-y border-border/50">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 grayscale dark:invert opacity-40 hover:grayscale-0 dark:hover:invert-0 hover:opacity-100 transition-all duration-700">
