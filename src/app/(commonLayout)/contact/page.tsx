        ...
        <div className="max-w-7xl mx-auto space-y-20">
          ...
          <div className="relative group">
              ...
              <div className="relative h-[400px] w-full rounded-[3.5rem] overflow-hidden border-8 border-background shadow-2xl">
                  {/* Actual Map Placeholder Styling */}
                  <div className="absolute inset-0 bg-zinc-900 flex items-center justify-center">
                    <div className="absolute inset-0 opacity-20 grayscale bg-[url('https://api.placeholder.com/1200/400')] bg-cover"></div>
                    <div className="relative z-10 text-center space-y-4">
                         <div className="w-20 h-20 bg-primary/20 rounded-3xl flex items-center justify-center mx-auto border border-primary/30 backdrop-blur-md">
                            <MapPin className="w-10 h-10 text-primary animate-bounce" />
                         </div>
                         <div>
                            <h4 className="text-2xl font-black text-white italic tracking-tight">Main Campus Placeholder</h4>
                            <p className="text-white/40 font-bold uppercase tracking-widest text-[10px]">Silicon Valley, CA, United States</p>
                         </div>
                    </div>
                  </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-background border border-border rounded-[3rem] p-8 md:p-12 shadow-2xl shadow-primary/5">
              <div className="space-y-8">
                ...
                <form className="space-y-6">
                  ...
                  <button className="w-full h-16 bg-primary text-primary-foreground rounded-2xl font-black uppercase tracking-widest text-sm flex items-center justify-center gap-3 shadow-xl shadow-primary/20 hover:translate-y-[-2px] hover:shadow-2xl active:translate-y-0 transition-all">
            ...
            <div className="space-y-12 py-10 lg:pl-10">
              ...
              {/* FAQ Section */}
              <div className="space-y-8">
                <h3 className="text-3xl font-black tracking-tight">Common Questions</h3>
                <div className="space-y-4">
                  <FaqItem 
                    question="How do I get my certificate?" 
                    answer="Certificates are automatically generated once you complete 100% of the lessons in a course. You can download it directly from your dashboard." 
                  />
                  <FaqItem 
                    question="Can I get a refund?" 
                    answer="We offer a 30-day money-back guarantee for all courses, provided you haven't consumed more than 20% of the content." 
                  />
                  <FaqItem 
                    question="Is there a subscription plan?" 
                    answer="Currently, we offer one-time purchases per course. However, an 'All-Access' annual pass is launching next month!" 
                  />
                </div>
              </div>
...
function FaqItem({ question, answer }: { question: string; answer: string }) {
    return (
        <div className="p-6 bg-secondary/30 border border-border/50 rounded-2xl space-y-2 hover:bg-background hover:border-primary/20 transition-all cursor-default">
            <h4 className="font-black text-sm text-foreground">{question}</h4>
