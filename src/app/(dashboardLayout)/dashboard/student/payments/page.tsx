    ...
    <div className="max-w-7xl mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-1000 pb-20">
      ...
      <section className="flex flex-col md:flex-row justify-between items-end gap-8">
        <div className="space-y-4">
           <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/5 border border-primary/10 rounded-full">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-primary">Academic Investment History</span>
           </div>
           <h1 className="text-5xl md:text-6xl font-black tracking-tighter text-foreground leading-[0.9]">
              Payments & <br />
              <span className="text-primary italic font-serif">Enrollments.</span>
           </h1>
           <p className="text-muted-foreground text-lg font-medium max-w-xl leading-relaxed">
              Tracking your financial commitment to professional growth and knowledge acquisition.
           </p>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-8 bg-card border border-border rounded-[2.5rem] relative overflow-hidden group">
           ...
           <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-4">Total Investment</p>
        ...
        <div className="p-8 bg-card border border-border rounded-[2.5rem] relative overflow-hidden group">
           ...
           <p className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] mb-4">Active Assets</p>
        ...
        <div className="p-8 bg-primary text-white rounded-[2.5rem] relative overflow-hidden group shadow-xl shadow-primary/20">
           ...
           <p className="text-[10px] font-black text-white/60 uppercase tracking-[0.2em] mb-4">Status</p>
      ...
      <div className="bg-card border border-border rounded-[3.5rem] overflow-hidden">
        <div className="p-10 border-b border-border/50 bg-secondary/20">
           ...
           <p className="text-muted-foreground font-medium text-xs">A comprehensive record of your platform enrollments.</p>
        </div>
           ...
           <table className="w-full text-left">
              <thead>
                 <tr className="bg-secondary/10 border-b border-border/50">
                    <th className="px-10 py-6 text-[10px) font-black uppercase tracking-widest text-muted-foreground">Course Details</th>
                    ...
                    <th className="px-10 py-6 text-[10px] font-black uppercase tracking-widest text-muted-foreground text-right">Amount</th>
                 </tr>
              </thead>
                       ...
                       <td className="px-10 py-8">
                          <div className="flex items-center gap-4">
                             ...
                             <div>
                                ...
                                <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Enrollment Verified</p>
                             </div>
                          </div>
                       </td>
                       <td className="px-10 py-8">
